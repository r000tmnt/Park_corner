    ...
    const languages = {
        zh_tw: {
            ...
            types_caption: "幫助你完善自創的角色形象 | 縮短您心中的想像與現實的距離 | 一眼感受到畫面的敘事性 | 集合眾人的力量",
            service: "互助合作 | 時間掌控 | 多樣變化",
            serviceDesc: "縮短想像與現實的距離，尋求雙方滿意的成品。 | 不開天窗是接案人的職責，定期與委託人確認進度。 | 簡單留白，賽璐璐或是油彩厚塗? 風格是可以切換的。",
            AboutMe: "半路覺醒成為獸控的阿宅，以畫筆表達對作品的喜好。曾經瘋了五年的忍者龜，對風格的影響顯而易見。",
            link: "作品參考:", 
            email: "聯絡方式:",
            workFlow: "委託流程",
            workFlow_title: "1.請聲明委託用途 | 2.付款相關",
            workFlow_desc_1: "請以私訊或電子信件聯絡。 基本可用於個人收藏。 | 上傳插畫至個人部落格(FB、Twiiter)請標註繪師名稱。 | 尺寸預設為A4，300dpi。 若有其他尺寸需求請事先告知。 | 繪師接受原創、二創和獸人或NSFW...等題材，但不接受血腥、過激的元素。 請提供參考圖或是內容描述(越詳盡越好)。",
            workFlow_desc_2: "作品最多可提出3次修改，超過視情況加收費用。 | 委託金可以分兩次或一次付清。兩次分為草稿確認與完稿確認。 台灣國內請匯至指定銀行帳戶，海外委託請用Paypal付款。 | 繪師有權將委託視為自己的作品之一，並發布於社群網站(如Pixix、Twitter)。 若不願公開請事先告知。 | 一般公司商業委託，請另外來信詢價。",
            reference: "參考",
            reference_note: "未列出格式不代表無法接受，可與繪師討論",
            reference_styles: "灰階 | 賽璐璐 | 油彩厚塗",
            reference_prices: "NT 450 | NT 1500 | NT 2550",
        ...
        eng: {
            ...
            types_caption: "Help you perfect the image of your own character | Shorten the distance between imagination and reality | The sence of narrative at a glance | Together, we can make things better",
            service: "Mutual interest | Time management | Variaty of style",
            serviecDesc: "Seek the produt that will satisfy both side. | Freelance is duty to not meet the deadline, contact regularly. | Simplify, cel-shading or oil paint-ish? The style is your choice.",
            ...
            reference_prices: "15 USD | 50 USD | 85 USD",
