window.onload = function(){
    ...
    dataReload.forEach(el => {
        el.addEventListener('click', () => {
            ...
            trM[1].innerHTML = '<td>'+ languages[attr].table[3] +'</td><td data-th="賽璐璐"><p class="demo bg-cover" style="background-image: url(images/Commission_Demo-celShading.jpg);"></p></td><td>'+ languages[attr].table[6] +'</td>';
